...
# На этом этапе пользователь по сути уже ввел сумму и тип операции
# Для добавления в БД транзакции прихода нужны:
# + Сумма (уже введена)
# + Тип (уже выбран кнопкой)
# - Категорию (выбор из БД)
# - Куда пришли деньги (выбор из БД)
# - Комментарий (ввести текстом)
